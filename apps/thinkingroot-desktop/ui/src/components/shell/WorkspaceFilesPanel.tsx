/**
 * Right-rail workspace file inspector — Cursor-style tree over the
 * registered workspace root, optional `.thinkingroot` scope, text
 * preview, and one-click `.tr` pack export.
 */
...
export function WorkspaceFilesPanel({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      <section className="flex max-h-[min(42vh,340px)] min-h-0 shrink-0 flex-col border-b border-border/50 bg-muted/[0.04]">
